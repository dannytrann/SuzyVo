...
!function () {
    ...
    function e(e, t, n) {
            ...
            function d(n) {
                switch (n.keyCode) {
                    ...
                    case t.KEY_CODE.UP_ARROW:
                        n.preventDefault(), l.selectPrevious();
                        break;
                    case t.KEY_CODE.RIGHT_ARROW:
                    case t.KEY_CODE.DOWN_ARROW:
                        n.preventDefault(), l.selectNext();
                        break;
                    case t.KEY_CODE.ENTER:
                        var i = angular.element(e.getClosest(r[0], "form"));
                        i.length > 0 && i.triggerHandler("submit")
                }
            }

            n(r);
            var l = o[0], c = o[1] || e.fakeNgModel();
            l.init(c), r.attr({role: "radiogroup", tabIndex: r.attr("tabindex") || "0"}).on("keydown", d)
        }
        ...
        function o(t, n) {
            ...
            if (i.count()) {
                ...
                }, a = t[0].querySelector("md-radio-button.md-checked"), o = i[0 > n ? "previous" : "next"](a, r) || i.first();
    ...
    function t(e, t, n) {
        function i(i, a, o, d) {
            function l(e) {
                a[0].hasAttribute("disabled") || i.$apply(function () {
                    d.setViewValue(o.value, e && e.type)
                })
            }

            function c() {
                var e = d.getViewValue() == o.value;
                e !== s && (s = e, a.attr("aria-checked", e), e ? (a.addClass(r), d.setActiveDescendant(a.attr("id"))) : a.removeClass(r))
            }

            function u(n, i) {
                function r() {
                    return o.id || "radio_" + t.nextUid()
                }
            ...
            var s;
            n(a), u(a, i), d.add(c), o.$observe("value", c), a.on("click", l).on("$destroy", function () {
                d.remove(c)
            })
        }
