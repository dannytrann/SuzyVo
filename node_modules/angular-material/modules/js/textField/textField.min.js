...
!function () {
    ...
    function t(t, e, n, i) {
        return {
            ...
            compile: function (a, r) {
                return i.warn("<md-text-float> is deprecated. Please use `<md-input-container>` and `<input>`.More information at http://material.angularjs.org/#/api/material.components.input/directive/mdInputContainer"), angular.isUndefined(r.mdFid) && (r.mdFid = e.nextUid()), {
                    pre: function (t, e, i) {
                        var a = n(i.ngDisabled);
    ...
    function e(t) {
        return {
            restrict: "CE", controller: ["$element", function (e) {
    ...
    function n(t, e) {
        return {
            ...
            link: function (t, n, i, a) {
                ...
                if (a[0]) {
                    e.warn("<md-input> is deprecated. Please use `<md-input-container>` and `<input>`.More information at http://material.angularjs.org/#/api/material.components.input/directive/mdInputContainer");
                    var u = a[0], o = a[1];
                    t.$watch(t.isDisabled, function (t) {
