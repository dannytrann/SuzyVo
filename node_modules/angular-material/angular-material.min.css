...
.md-ripple.md-ripple-placed {
    transition: left .9s cubic-bezier(.25, .8, .25, 1), top .9s cubic-bezier(.25, .8, .25, 1), margin .65s cubic-bezier(.25, .8, .25, 1), border .65s cubic-bezier(.25, .8, .25, 1), width .65s cubic-bezier(.25, .8, .25, 1), height .65s cubic-bezier(.25, .8, .25, 1), opacity .65s cubic-bezier(.25, .8, .25, 1), -webkit-transform .65s cubic-bezier(.25, .8, .25, 1);
    transition: left .9s cubic-bezier(.25, .8, .25, 1), top .9s cubic-bezier(.25, .8, .25, 1), margin .65s cubic-bezier(.25, .8, .25, 1), border .65s cubic-bezier(.25, .8, .25, 1), width .65s cubic-bezier(.25, .8, .25, 1), height .65s cubic-bezier(.25, .8, .25, 1), opacity .65s cubic-bezier(.25, .8, .25, 1), transform .65s cubic-bezier(.25, .8, .25, 1)
}
...
md-tabs-ink-bar.md-transition-right {
    transition: right .25s cubic-bezier(.35, 0, .25, 1), left .25s cubic-bezier(.35, 0, .25, 1) .075s
}

md-tabs-ink-bar.md-transition-left {
    transition: right .25s cubic-bezier(.35, 0, .25, 1) .075s, left .25s cubic-bezier(.35, 0, .25, 1)
}
...
md-tab {
    ...
    padding: 20px 24px;
    box-sizing: border-box;
    transition: background .35s cubic-bezier(.35, 0, .25, 1), color .35s cubic-bezier(.35, 0, .25, 1);
    -webkit-user-select: none;
    -moz-user-select: none;
    -ms-user-select: none;
    user-select: none
