 ...
 * v0.7.0
 */
function mdMediaFactory(e, t, n, r) {
    function o(e) {
        var t = d.get(e);
        angular.isUndefined(t) && (t = d.put(e, a(e)));
        var n = l.get(t);
    ...
    function i(e) {
        return l.put(e, !!r.matchMedia(e).matches)
    }

    function c() {
        var e = l.keys(), t = e.length;
        if (t) {
            for (var r = 0; t > r; r++)i(e[r]);
            n.$evalAsync()
        }
    }

    var d = t.cacheFactory("$mdMedia:queries", {capacity: 15}), l = t.cacheFactory("$mdMedia:results", {capacity: 15});
    return angular.element(r).on("resize", c), o
}
 ...
 */
    function () {
        ...
        function t(e, t) {
            ...
            e.decorator("$$rAF", ["$delegate", "$rootScope", n]), t.theme("default").primaryColor("blue").accentColor("green").warnColor("red").backgroundColor("grey")
        }
 ...
 */
    function () {
        function e(e, t) {
            ...
            function l(e, t) {
                return e ? (angular.isNumber(t) || (t = b.length), b.splice(t, 0, e), u(e)) : -1
            }
            ...
            function h(e, n, r, a) {
                ...
                return o(c) ? d = b[c] : t && (d = e ? p() : f(), c = u(d)), null === d || c === a ? null : (angular.isUndefined(a) && (a = c), r(d) ? d : h(e, d, r, a))
            }
 ...
 */
    function () {
        "use strict";
        var e = ["0", "0", "0"];
        angular.module("material.core").factory("$mdUtil", ["$cacheFactory", "$document", "$timeout", function (t, n, r) {
            function o(e, t) {
                function r() {
                    r.called || (r.called = !0, t.off(p, o), n.off(h, a).off(g, c), u = f = !1)
                }

                function o(e) {
                    var n = e.type.charAt(0), r = i.now();
                    s && s.pointerType !== n && r - s.endTime < 400 || f || (f = !0, u = {
                        pointerType: n,
                        startX: l(e),
                        startTime: r
                    }, t.one("$md.dragstart", function (e) {
                        e.defaultPrevented && (u = null)
                    }), t.triggerHandler("$md.dragstart", u))
                }

                function a(e) {
                    u && m(e, u) && (("t" === u.pointerType || "p" === u.pointerType) && e.preventDefault(), d(e), t.triggerHandler("$md.drag", u))
                }

                function c(e) {
                    f = !1, u && m(e, u) && (u.endTime = i.now(), d(e), t.triggerHandler("$md.dragend", u), s = u, u = null)
                }

                function d(e) {
                    var t = l(e);
                    u.distance = u.startX - t, u.direction = u.distance > 0 ? "left" : u.distance < 0 ? "right" : "", u.duration = u.startTime - i.now(), u.velocity = Math.abs(u.duration) / u.time
                }
                ...
                var u, s, f, p = "mousedown touchstart pointerdown", h = "mousemove touchmove pointermove", g = "mouseup mouseleave touchend touchcancel pointerup pointercancel";
                return t.on(p, o), n.on(h, a).on(g, c), e.$on("$destroy", r), r
            }

            function a(e, n) {
                var r = t(e, n), o = {};
                return r._put = r.put, r.put = function (e, t) {
                    return o[e] = !0, r._put(e, t)
                }, r._remove = r.remove, r.remove = function (e) {
                    return delete o[e], r._remove(e)
                }, r._removeAll = r.removeAll, r.removeAll = function () {
                    return o = {}, r._removeAll()
                }, r._destroy = r.destroy, r.destroy = function () {
                    return o = {}, r._destroy()
                }, r.keys = function () {
            ...
            return i = {
                ...
                attachDragBehavior: o,
                elementRect: function (e, t) {
                    var n = e[0];
                    t = t || n.offsetParent || document.body, t = t[0] || t;
                    var r = n.getBoundingClientRect(), o = t.getBoundingClientRect();
                    return {
                        left: r.left - o.left + t.scrollLeft,
                        top: r.top - o.top + t.scrollTop,
                        width: r.width,
                        height: r.height
                    }
                },
                ...
                throttle: function (e, t) {
                    var n;
                    return function () {
                        var r = this, o = arguments, a = i.now();
 ...
 */
    function () {
        ...
        function e(e, t, n) {
            function r(e, n, r) {
                var o = e[0];
                o.hasAttribute(n) || i(o, n) || (r = angular.isString(r) && r.trim() || "", r.length ? e.attr(n, r) : t.warn('ARIA: Attribute "', n, '", required for accessibility, is missing on node:', o))
            }
    ...
    function () {
        ...
        function e(e, t, n, r, o, a) {
            this.compile = function (i) {
                var c = i.templateUrl, d = i.template || "", l = i.controller, m = i.controllerAs, u = i.resolve || {}, s = i.locals || {}, f = i.transformTemplate || angular.identity, p = i.bindToController;
                return angular.forEach(u, function (e, t) {
                    u[t] = angular.isString(e) ? n.get(e) : n.invoke(e)
                }), angular.extend(u, s), u.$template = c ? t.get(c, {cache: a}).then(function (e) {
                    return e.data
                }) : e.when(d), e.all(u).then(function (e) {
                    var t = f(e.$template), n = angular.element("<div>").html(t.trim()).contents(), a = r(n);
                    return {
                        locals: e, element: n, link: function (t) {
                            if (e.$scope = t, l) {
                                var r = o(l, e);
                                p && angular.extend(r, e), n.data("$ngControllerController", r), n.children().data("$ngControllerController", r), m && (t[m] = r)
                            }
                            return a(t)
                        }
                    }
 ...
 */
    function () {
        ...
        function e() {
            function e(e) {
                function t(e) {
                    return a.optionsFactory = e.options, a.methods = (e.methods || []).concat(o), i
                }
                ...
                function r(t, n, r) {
                    function o(e) {
                        return e && e._options && (e = e._options), l.show(angular.extend({}, d, e))
                    }
                    ...
                    var c, d, l = t(), m = {hide: l.hide, cancel: l.cancel, show: o};
                    return c = a.methods || [], d = i(a.optionsFactory, {}), angular.forEach(a.presets, function (e, t) {
                        function n(e) {
                            this._options = angular.extend({}, r, e)
                        }

                        var r = i(e.optionsFactory, {}), o = (e.methods || []).concat(c);
                ...
                var o = ["onHide", "onShow", "onRemove"], a = {presets: {}}, i = {
                    setDefaults: t,
                    addPreset: n,
                    $get: r
                };
                return i.addPreset("build", {methods: ["controller", "controllerAs", "resolve", "template", "templateUrl", "themable", "transformTemplate", "parent"]}), r.$inject = ["$$interimElement", "$animate", "$injector"], i
            }

            function t(e, t, n, r, o, a, i, c, d) {
                function l(e) {
                    return e && angular.isString(e) ? e.replace(/\{\{/g, m).replace(/}}/g, u) : e
                }

                var m = i.startSymbol(), u = i.endSymbol(), s = "{{" === m && "}}" === u, f = s ? angular.identity : l;
                return function () {
                    function i(e) {
                        p.length && s.cancel();
                        var t = new u(e);
                    ...
                    function u(i) {
                        ...
                        return i = i || {}, i = angular.extend({
                            ...
                            deferred: t.defer(),
                            show: function () {
                                return c.compile(i).then(function (n) {
                                    function a() {
                                        i.hideDelay && (m = r(s.cancel, i.hideDelay))
                                    }

                                    angular.extend(n.locals, l.options), angular.isString(i.parent) ? i.parent = angular.element(e[0].querySelector(i.parent)) : i.parent || (i.parent = o.find("body"), i.parent.length || (i.parent = o)), u = n.link(i.scope), i.themable && d(u);
                                    var c = i.onShow(i.scope, u, i);
                                    return t.when(c).then(function () {
                                        (i.onComplete || angular.noop)(i.scope, u, i), a()
                                    })
                                })
                            },
                            cancelTimeout: function () {
                                m && (r.cancel(m), m = void 0)
                            },
                            remove: function () {
                                l.cancelTimeout();
                                var e = i.onRemove(i.scope, u, i);
                    ...
                    var s, p = [];
                    return s = {show: i, hide: l, cancel: m}
                }
            }
 ...
 */
    function () {
        ...
        function t(e, t) {
            ...
            function r(e, t, n) {
                return a(e, t, angular.extend({center: !0, dimBackground: !1}, n))
            }
            ...
            function a(n, r, o) {
                ...
                function i(e, n) {
                    p.splice(p.indexOf(e), 1), 0 === p.length && m && m.css({backgroundColor: ""}), t(function () {
                        e.remove()
                    }, n, !1)
                }

                function c(e) {
                    var t = p.indexOf(e), n = h[t] || {}, r = p.length > 1 ? !1 : b, a = p.length > 1 ? !1 : E;
                    r || n.animating || a ? e.addClass("md-ripple-visible") : e && (e.removeClass("md-ripple-visible"), o.outline && e.css({
                        width: u + "px",
                        height: u + "px",
                        marginLeft: -1 * u + "px",
                        marginTop: -1 * u + "px"
                    }), i(e, o.outline ? 450 : 650))
                }

                function d(n, i) {
                    function d(e) {
                        var t = angular.element('<div class="md-ripple" data-counter="' + f++ + '">');
                        return p.unshift(t), h.unshift({animating: !0}), b.append(t), e && t.css(e), t
                    }

                    function l(e, t) {
                        var n, r, a, i = b.prop("offsetWidth"), c = b.prop("offsetHeight");
                        return o.isMenuItem ? r = Math.sqrt(Math.pow(i, 2) + Math.pow(c, 2)) : o.outline ? (a = v.getBoundingClientRect(), e -= a.left, t -= a.top, i = Math.max(e, i - e), c = Math.max(t, c - t), r = 2 * Math.sqrt(Math.pow(i, 2) + Math.pow(c, 2))) : (n = o.isFAB ? 1.1 : .8, r = Math.max(i, c) * n), r
                    }
                    ...
                    function s(e, t, n) {
                        ...
                        var a, i = {backgroundColor: r(M), borderColor: r(M), width: e + "px", height: e + "px"};
                        return o.outline ? (i.width = 0, i.height = 0) : i.marginLeft = i.marginTop = e * -.5 + "px", o.center ? i.left = i.top = "50%" : (a = v.getBoundingClientRect(), i.left = Math.round((t - a.left) / b.prop("offsetWidth") * 100) + "%", i.top = Math.round((n - a.top) / b.prop("offsetHeight") * 100) + "%"), i
                    }

                    function g() {
                        if (m)return m;
                        var e = angular.element('<div class="md-ripple-container"></div>');
                        return m = e, r.append(e), e
                    }

                    M = a(r.attr("md-ink-ripple")) || a(e.getComputedStyle(o.colorElement[0]).color || "rgb(0, 0, 0)");
                    var b = g(), E = l(n, i), $ = s(E, n, i), A = d($), T = p.indexOf(A), k = h[T] || {};
                    return u = E, k.animating = !0, t(function () {
                        o.dimBackground && b.css({backgroundColor: M}), A.addClass("md-ripple-placed md-ripple-scaled"), o.outline ? A.css({
                            borderWidth: .5 * E + "px",
                            marginLeft: E * -.5 + "px",
                            marginTop: E * -.5 + "px"
                        }) : A.css({left: "50%", top: "50%"}), c(A), t(function () {
                            k.animating = !1, c(A)
                        }, o.outline ? 450 : 225, !1)
                    }, 0, !1), A
                }
                ...
                function l(e) {
                    function n() {
                        ...
                        var t = v.parentNode, n = t && t.parentNode, r = n && n.parentNode;
                        return !(e(v) || e(t) || e(n) || e(r))
                    }

                    var r, o;
                    e.eventType === Hammer.INPUT_START && e.isFirst && n() ? (r = d(e.center.x, e.center.y), E = !0) : e.eventType === Hammer.INPUT_END && e.isFinal && (E = !1, o = p.length - 1, r = p[o], t(function () {
                        c(r)
                    }, 0, !1))
                }
                ...
                var m, u, s = r.controller("mdInkRipple") || {}, f = 0, p = [], h = [], g = r.attr("md-highlight"), b = !1, E = !1, v = r[0], $ = new Hammer(v), M = a(r.attr("md-ink-ripple")) || a(e.getComputedStyle(o.colorElement[0]).color || "rgb(0, 0, 0)");
                return n._onInput = l, o.mousedown && $.on("hammer.input", l), s.createRipple = d, g && n.$watch(g, function (e) {
                    b = e, b && !p.length && t(function () {
                        d(0, 0)
                    }, 0, !1), angular.forEach(p, c)
                }), function () {
                    $.destroy(), m && m.remove()
                }
            }
 ...
 */
    function () {
        ...
        function e(e) {
            ...
            function i(e) {
                function t(e) {
                    if (e = 0 === arguments.length ? !0 : !!e, e !== n.isDark) {
                        n.isDark = e, n.foregroundPalette = n.isDark ? f : s, n.foregroundShadow = n.isDark ? p : h;
                        var t = n.isDark ? M : $, r = n.isDark ? $ : M;
                ...
                n.name = e, n.colors = {}, n.dark = t, t(!1), E.forEach(function (e) {
                    ...
                    n[e + "Color"] = function (r, o) {
                        ...
                        return Object.keys(a.hues).forEach(function (e) {
                            ...
                            if (-1 == A.indexOf(t))throw new Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1", t).replace("%2", n.name).replace("%3", e).replace("%4", r).replace("%5", A.join(", ")))
                        }), n
                    }
                })
            }
            ...
            function u(e) {
                function t(n, r) {
                    void 0 === r && (r = n, n = void 0), void 0 === n && (n = e), t.inherit(r, r)
                }
                ...
                return t.inherit = function (t, n) {
                    ...
                    var o = n.controller("mdTheme"), a = t.attr("md-theme-watch");
                    if ((b || angular.isDefined(a)) && "false" != a) {
                        var i = e.$watch(function () {
                            return o && o.$mdTheme || g
                        }, r);
                        t.on("$destroy", i)
                    } else {
                        var c = o && o.$mdTheme || g;
            ...
            d = {}, l = {};
            var g = "default", b = !1;
            return angular.extend(d, e), u.$inject = ["$rootScope"], m = {
                definePalette: t,
                extendPalette: n,
                theme: a,
            ...
            return {
                priority: 100, link: {
                    pre: function (t, n, r) {
                        ...
                        n.data("$mdThemeController", o), o.$setTheme(e(r.mdTheme)(t)), r.$observe("mdTheme", o.$setTheme)
                    }
                }
            }
        }
        ...
        function r(e, t, n) {
            ...
            var r = [], o = e.colors[t], i = new RegExp(".md-" + e.name + "-theme", "g"), l = new RegExp("('|\")?{{\\s*(" + t + ")-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?", "g"), m = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow)-?(\d\.?\d*)?\s*\}\}'?"?/g, u = d[o.name];
            return n = n.replace(m, function (t, n, r, o) {
                ...
                var a = n.replace(l, function (e, n, r, o, a) {
                    return c(u[t]["color" === o ? "value" : "contrast"], a)
                });
        ...
        function o(e) {
            function t(e) {
                var t = e.contrastDefaultColor, n = e.contrastLightColors || [], r = e.contrastDarkColors || [];
                "string" == typeof n && (n = n.split(" ")), "string" == typeof r && (r = r.split(" ")), delete e.contrastDefaultColor, delete e.contrastLightColors, delete e.contrastDarkColors, angular.forEach(e, function (o, a) {
                    function c() {
                        return "light" === t ? r.indexOf(a) > -1 ? g : b : n.indexOf(a) > -1 ? b : g
                    }

                    if (!angular.isObject(o)) {
                        var d = i(o);
                        if (!d)throw new Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1", o).replace("%2", e.name).replace("%3", a));
                        e[a] = {value: d, contrast: c()}
                    }
                })
            }
            ...
            if (angular.forEach(l, function (e) {
                ...
                f.insertBefore(s, f.firstElementChild), u = !0
            }
        }
        ...
        function i(e) {
            ...
            if (/^rgb/.test(e))return e.replace(/(^\s*rgba?\(|\)\s*$)/g, "").split(",").map(function (e) {
        ...
        function c(e, t) {
            return 4 == e.length && (t = e.pop()), t && t.length ? "rgba(" + e.join(",") + "," + t + ")" : "rgb(" + e.join(",") + ")"
        }
        ...
        }, p = "1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)", h = "", g = i("rgba(0,0,0,0.87)"), b = i("rgb(255,255,255)"), E = ["primary", "accent", "warn", "background"], v = "primary", $ = {
            accent: {
                "default": "A700",
                "hue-1": "A200",
                "hue-2": "A400",
        ...
        }, M = {background: {"default": "500", "hue-1": "300", "hue-2": "600", "hue-3": "800"}};
        E.forEach(function (e) {
            var t = {"default": "500", "hue-1": "300", "hue-2": "800", "hue-3": "A100"};
            $[e] || ($[e] = t), M[e] || (M[e] = t)
        });
        var A = ["50", "100", "200", "300", "400", "500", "600", "700", "800", "900", "A100", "A200", "A400", "A700"];
        e.$inject = ["$mdColorPalette"], t.$inject = ["$interpolate"], n.$inject = ["$mdTheming"], o.$inject = ["$injector"]
    }(), /*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 */
    function () {
        ...
        function t(e) {
            function t(e, t, n, r, o, a, i, c) {
                function d(r, d, l) {
                    u = o('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(r), u.on("click touchstart", function () {
                        n(i.cancel)
                    }), a.inherit(u, l.parent), e.enter(u, l.parent, null);
                    var s = new m(d);
                    return l.bottomSheet = s, l.targetEvent && angular.element(l.targetEvent.target).blur(), a.inherit(s.element, l.parent), e.enter(s.element, l.parent).then(function () {
                ...
                function l(t, n, r) {
                    var o = r.bottomSheet;
                    return e.leave(u), e.leave(o.element).then(function () {
                        o.cleanup(), r.targetEvent && angular.element(r.targetEvent.target).focus()
                    })
                }

                function m(e) {
                    function r(n) {
                        n.preventDefault(), p = n.target, m = c(n), f = e.css(t.CSS.TRANSITION_DURATION), e.css(t.CSS.TRANSITION_DURATION, "0s")
                    }

                    function o(r) {
                        e.css(t.CSS.TRANSITION_DURATION, f);
                        var o = c(r);
                        Math.abs(o - m) < 5 && r.target == p ? angular.element(r.target).triggerHandler("click") : s > b ? n(i.cancel) : d(void 0)
                    }

                    function a(e) {
                        var t = c(e), n = t - m;
                        s = t - u, u = t, n = l(n), d(n + h)
                    }
                    ...
                    function l(e) {
                        if (0 > e && -h + g > e) {
                            e = -e;
                            var t = h - g;
                            e = Math.max(-h, -Math.min(h - 5, t + g * (e - t) / h) - e / 50)
                        }
                        return e
                    }

                    var m, u, s, f, p, h = 80, g = 20, b = 10;
                    return e = e.eq(0), e.on("touchstart", r).on("touchmove", a).on("touchend", o), {
                        element: e,
                        cleanup: function () {
                            e.off("touchstart", r).off("touchmove", a).off("touchend", o)
                        }
                    }
                }

                var u;
                return {themable: !0, targetEvent: null, onShow: d, onRemove: l, escapeToClose: !0}
            }
 ...
 */
    function () {
        ...
        function e(e, t, n) {
            ...
            return {restrict: "E", replace: !0, transclude: !0, template: o, link: a}
        }
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o, a) {
            function i(t, i) {
                return i.type = "checkbox", i.tabIndex = 0, t.attr("role", i.type), function (i, d, l, m) {
                    function u(e) {
                        e.which === r.KEY_CODE.SPACE && (e.preventDefault(), s(e))
                    }

                    function s(e) {
                        d[0].hasAttribute("disabled") || i.$apply(function () {
                            p = !p, m.$setViewValue(p, e && e.type), m.$render()
                        })
                    }

                    function f() {
                        p = m.$viewValue, p ? d.addClass(c) : d.removeClass(c)
                    }

                    m = m || a.fakeNgModel();
                    var p = !1;
                    o(d), n.expectWithText(t, "aria-label"), e.link.pre(i, {
                        on: angular.noop,
                        0: {}
                    }, l, [m]), l.mdNoClick || d.on("click", s), d.on("keypress", u), m.$render = f
                }
            }
 ...
 */
    function () {
        ...
        function e(e) {
            ...
            return {
                restrict: "E", controller: ["$scope", "$element", t], link: function (t, n) {
 ...
 */
    function () {
        ...
        function t(e) {
            ...
            function n(e, t, n, r, o, a, i, c, d, l, m, u) {
                function s(n, o, a) {
                    function i() {
                    ...
                    var l = i();
                    return p(o.find("md-dialog")), a.hasBackdrop && (a.backdrop = angular.element('<md-backdrop class="md-dialog-backdrop md-opaque">'), d.inherit(a.backdrop, a.parent), r.enter(a.backdrop, a.parent)), a.disableParentScroll && (a.oldOverflowStyle = a.parent.css("overflow"), a.parent.css("overflow", "hidden")), h(o, a.parent, a.popInTarget && a.popInTarget.length && a.popInTarget).then(function () {
                        a.escapeToClose && (a.rootElementKeyupCallback = function (t) {
                            t.keyCode === c.KEY_CODE.ESCAPE && e(u.cancel)
                        }, t.on("keyup", a.rootElementKeyupCallback)), a.clickOutsideToClose && (a.dialogClickOutsideCallback = function (t) {
                            t.target === o[0] && e(u.cancel)
                        }, o.on("click", a.dialogClickOutsideCallback)), l.focus()
                    })
                }

                function f(e, n, o) {
                    return o.backdrop && r.leave(o.backdrop), o.disableParentScroll && (o.parent.css("overflow", o.oldOverflowStyle), a[0].removeEventListener("scroll", o.captureScroll, !0)), o.escapeToClose && t.off("keyup", o.rootElementKeyupCallback), o.clickOutsideToClose && n.off("click", o.dialogClickOutsideCallback), g(n, o.parent, o.popInTarget && o.popInTarget.length && o.popInTarget).then(function () {
                ...
                function g(e, t, n) {
                    var r = e.find("md-dialog");
                    return r.addClass("transition-out").removeClass("transition-in"), b(r, n), E(r)
                }
                ...
                function E(e) {
                    function t(r) {
                        r.target === e[0] && (e.off(c.CSS.TRANSITIONEND, t), n.resolve())
                    }

                    var n = m.defer();
                    return e.on(c.CSS.TRANSITIONEND, t), n.promise
                }
            ...
            return t.$inject = ["$mdDialog"], n.$inject = ["$timeout", "$rootElement", "$compile", "$animate", "$mdAria", "$document", "$mdUtil", "$mdConstant", "$mdTheming", "$$rAF", "$q", "$mdDialog"], e("$mdDialog").setDefaults({
                methods: ["disableParentScroll", "hasBackdrop", "clickOutsideToClose", "escapeToClose", "targetEvent"],
                options: n
            }).addPreset("alert", {
                methods: ["title", "content", "ariaLabel", "ok"],
                options: t
            }).addPreset("confirm", {methods: ["title", "content", "ariaLabel", "ok", "cancel"], options: t})
        }
 ...
 */
    function () {
        ...
        function e() {
            return {
                restrict: "E", template: '<object class="md-icon"></object>', compile: function (e, t) {
 ...
 */
    function () {
        ...
        function t() {
            return {
                restrict: "E", require: "^?mdInputContainer", link: function (e, t, n, r) {
                    r && (r.label = t, e.$on("$destroy", function () {
                        r.label = null
                    }))
                }
            }
        ...
        function n(e, t) {
            function n(n, r, o, a) {
                function i(e) {
                    return d.setHasValue(!m(e) || (r[0].validity || {}).badInput), e
                }
                ...
                function c() {
                    ...
                    function a() {
                        c.style.height = "auto";
                        var e = c.scrollHeight - c.offsetHeight;
                        c.scrollTop = 0;
                        var t = c.offsetHeight + (e > 0 ? e : 0);
                        c.style.height = t + "px"
                    }

                    function i() {
                        c.scrollTop = 0;
                        var e = c.scrollHeight - c.offsetHeight, t = c.offsetHeight + e;
                        c.style.height = t + "px"
                    }

                    var c = r[0], d = e.debounce(a, 1);
                    l ? (l.$formatters.push(o), l.$viewChangeListeners.push(o)) : d(), r.on("keydown input", d), r.on("scroll", i), angular.element(t).on("resize", d), n.$on("$destroy", function () {
                ...
                if (d) {
                    ...
                    d.input = r, r.addClass("md-input"), r.attr("id") || r.attr("id", "input_" + e.nextUid()), "textarea" === r[0].tagName.toLowerCase() && c();
                    var m = l ? l.$isEmpty : function () {
                        return 0 === ("" + r.val()).length
                    };
                    l ? (n.$watch(function () {
                        return l.$dirty && l.$invalid
                    }, d.setInvalid), l.$formatters.push(i), l.$parsers.push(i)) : i(), r.on("input", i), r.on("focus", function () {
                        d.setFocused(!0)
                    }).on("blur", function () {
                        d.setFocused(!1)
        ...
        angular.module("material.components.input", ["material.core"]).directive("mdInputContainer", e).directive("label", t).directive("input", n).directive("textarea", n).directive("mdMaxlength", r), e.$inject = ["$mdTheming"], n.$inject = ["$mdUtil", "$window", "$compile", "$animate"], r.$inject = ["$animate"]
    }(), /*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 ...
 */
    function () {
        ...
        function e(e, t, n) {
            ...
            function o(e, r, o) {
                n(r);
                var d, l, m, u, s = r[0], f = s.querySelectorAll(".md-fill, .md-mask.md-full"), p = s.querySelectorAll(".md-fill.md-fix"), h = o.mdDiameter || 48, g = h / 48;
                s.style[t.CSS.TRANSFORM] = "scale(" + g.toString() + ")", o.$observe("value", function (e) {
                    for (l = a(e), m = i[l], u = c[l], r.attr("aria-valuenow", l), d = 0; d < f.length; d++)f[d].style[t.CSS.TRANSFORM] = m;
                    for (d = 0; d < p.length; d++)p[d].style[t.CSS.TRANSFORM] = u
                })
            }
            ...
            for (var i = new Array(101), c = new Array(101), d = 0; 101 > d; d++) {
                var l = d / 100, m = Math.floor(180 * l);
                i[d] = "rotate(" + m.toString() + "deg)", c[d] = "rotate(" + (2 * m).toString() + "deg)"
            }
            return {
                restrict: "E",
 ...
 */
    function () {
        ...
        function e(e, n, r) {
            ...
            function a(o, a, c) {
                r(a);
                var d = a[0].querySelector(".md-bar1").style, l = a[0].querySelector(".md-bar2").style, m = angular.element(a[0].querySelector(".md-container"));
 ...
 */
    function () {
        ...
        function e(e, t, n) {
            ...
            function i(t, n) {
                var r = e.iterator(Array.prototype.slice.call(t[0].querySelectorAll("md-radio-button")), !0);
                if (r.count()) {
                    var o = function (e) {
        ...
        function t(e, t, n) {
            function r(r, a, i, c) {
                ...
                function l() {
                    ...
                    e !== u && (u = e, a.attr("aria-checked", e), e ? (a.addClass(o), c.setActiveDescendant(a.attr("id"))) : a.removeClass(o))
                }
                ...
                var u;
                n(a), m(a, r), c.add(l), i.$observe("value", l), a.on("click", d).on("$destroy", function () {
                    c.remove(l)
                })
            }
 ...
 */
    function () {
        ...
        function t(e, t, n, r, o, a, i, c, d) {
            function l(l, m, u, s) {
                function f(e, n) {
                    e === n ? m.toggleClass("md-locked-open", !!e) : t[e ? "addClass" : "removeClass"](m, "md-locked-open"), A.toggleClass("md-locked-open", !!e)
                }

                function p(e) {
                    var n = m.parent();
                    return n[e ? "on" : "off"]("keydown", g), A[e ? "on" : "off"]("click", b), e && (E = d[0].activeElement), v = c.all([t[e ? "enter" : "leave"](A, n), t[e ? "removeClass" : "addClass"](m, "md-closed").then(function () {
                        l.isOpen && m.focus()
                    })])
                }
                ...
                function h(t) {
                    ...
                    return l.isOpen = t, e(function () {
                        v.then(function (e) {
                            l.isOpen || (E && E.focus(), E = null), n.resolve(e)
                        })
                    }, 0, !1), n.promise
                }
                ...
                function b(e) {
                    return e.preventDefault(), e.stopPropagation(), s.close()
                }

                var E = null, v = c.when(!0), $ = n(u.mdIsLockedOpen), M = function () {
                    return $(l.$parent, {$media: r})
                }, A = a('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(l);
                m.on("$destroy", s.destroy), i.inherit(A, m), l.$watch(M, f), l.$watch("isOpen", p), s.$toggleOpen = h
            }
    ...
    function () {
        ...
        function t(e, t, n, r, o, a, i, c) {
            this.init = function (d) {
                ...
                function m(e) {
                    L = parseFloat(e), t.attr("aria-valuemin", e), l()
                }

                function u(e) {
                    U = parseFloat(e), t.attr("aria-valuemax", e), l()
                }
                ...
                function p() {
                    if (angular.isDefined(n.mdDiscrete)) {
                        var e = Math.floor((U - L) / V);
                        if (!W) {
                            var t = o.getComputedStyle(j[0]);
                            W = angular.element('<canvas style="position:absolute;">'), K = W[0].getContext("2d"), K.fillStyle = t.backgroundColor || "black", j.append(W)
                        }
                        var r = g();
                        W[0].width = r.width, W[0].height = r.height;
                        for (var a, i = 0; e >= i; i++)a = Math.floor(r.width * (i / e)), K.fillRect(a - 1, 0, 2, r.height)
                    }
                }
                ...
                function b(n) {
                    if (!t[0].hasAttribute("disabled")) {
                        var r;
                        n.keyCode === c.KEY_CODE.LEFT_ARROW ? r = -V : n.keyCode === c.KEY_CODE.RIGHT_ARROW && (r = V), r && ((n.metaKey || n.ctrlKey || n.altKey) && (r *= 4), n.preventDefault(), n.stopPropagation(), e.$evalAsync(function () {
                            E(d.$viewValue + r)
                        }))
                    }
                }
                ...
                function v() {
                    ...
                    var n = (d.$viewValue - L) / (U - L);
                    e.modelValue = d.$viewValue, t.attr("aria-valuenow", d.$viewValue), A(n), D.text(d.$viewValue)
                }

                function $(e) {
                    return angular.isNumber(e) ? Math.max(L, Math.min(U, e)) : void 0
                }

                function M(e) {
                    return angular.isNumber(e) ? Math.round(e / V) * V : void 0
                }

                function A(e) {
                    R.css("width", 100 * e + "%"), O.css(c.CSS.TRANSFORM, "translate3d(" + g().width * e + "px,0,0)"), t.toggleClass("md-min", 0 === e)
                }

                function T(e) {
                    z || e.eventType !== Hammer.INPUT_START || t[0].hasAttribute("disabled") ? z && e.eventType === Hammer.INPUT_END && (z && G && N(e), z = !1, t.removeClass("panning active")) : (z = !0, t.addClass("active"), t[0].focus(), h(), w(e), e.srcEvent.stopPropagation())
                }

                function k() {
                    z && t.addClass("panning")
                }

                function w(e) {
                    z && (G ? C(e.center.x) : y(e.center.x), e.preventDefault(), e.srcEvent.stopPropagation())
                }

                function N(e) {
                    if (G && !t[0].hasAttribute("disabled")) {
                        var n = H(_(e.center.x)), o = $(M(n));
                        A(x(o)), r(function () {
                            E(o)
                ...
                var S = angular.element(t[0].querySelector(".md-thumb")), D = angular.element(t[0].querySelector(".md-thumb-text")), O = S.parent(), I = angular.element(t[0].querySelector(".md-track-container")), R = angular.element(t[0].querySelector(".md-track-fill")), j = angular.element(t[0].querySelector(".md-track-ticks")), F = i.throttle(h, 5e3);
                n.min ? n.$observe("min", m) : m(0), n.max ? n.$observe("max", u) : u(100), n.step ? n.$observe("step", s) : s(1);
                var P = angular.noop;
                n.ngDisabled && (P = e.$parent.$watch(n.ngDisabled, f)), a.expect(t, "aria-label"), t.attr("tabIndex", 0), t.attr("role", "slider"), t.on("keydown", b);
                var q = new Hammer(t[0], {recognizers: [[Hammer.Pan, {direction: Hammer.DIRECTION_HORIZONTAL}]]});
                q.on("hammer.input", T), q.on("panstart", k), q.on("pan", w), q.on("panend", N), setTimeout(l);
                var B = r.debounce(l);
                angular.element(o).on("resize", B), e.$on("$destroy", function () {
                    angular.element(o).off("resize", B), q.destroy(), P()
                }), d.$render = v, d.$viewChangeListeners.push(v), d.$formatters.push($), d.$formatters.push(M);
                var L, U, V, W, K, Y = {};
                h();
                var z = !1, G = angular.isDefined(n.mdDiscrete);
                this._onInput = T, this._onPanStart = k, this._onPan = w
            }
        }
        ...
        function e(e, t, n, r, o) {
            function a(e) {
                function n(e, t) {
                    ...
                    return f.items.push(n), u.parent().prepend(n.clone), s(), function () {
                ...
                function o() {
                    ...
                    for (var e, t = u.prop("scrollTop"), n = f.items.length - 1; n >= 0; n--)if (t > f.items[n].top) {
                        e = f.items[n];
                        break
                    }
                    d(e)
                ...
                function a(e) {
                    var t = e.element[0];
                    for (e.top = 0, e.left = 0; t && t !== u[0];)e.top += t.offsetTop, e.left += t.offsetLeft, t = t.offsetParent;
                    e.height = e.element.prop("offsetHeight"), e.clone.css("margin-left", e.left + "px")
                }

                function i() {
                    var e = u.prop("scrollTop"), t = e > (i.prevScrollTop || 0);
                    i.prevScrollTop = e, 0 === e ? d(null) : t && f.next ? f.next.top - e <= 0 ? d(f.next) : f.current && (f.next.top - e <= f.next.height ? m(f.current, f.next.top - f.next.height - e) : m(f.current, null)) : !t && f.current && (e < f.current.top && d(f.prev), f.current && f.next && (e >= f.next.top - f.current.height ? m(f.current, f.next.top - e - f.current.height) : m(f.current, null)))
                }

                function d(e) {
                    if (f.current !== e) {
                        f.current && (m(f.current, null), l(f.current, null)), e && l(e, "active"), f.current = e;
                ...
                var u = e.$element, s = r.debounce(o);
                c(u), u.on("$scrollstart", s), u.on("$scroll", i);
                var f;
 ...
 */
    function () {
        ...
        function e() {
            return function (e, t) {
                return t || (t = "swipeleft swiperight"), function (n, r, o) {
                    function a(t) {
                        t.srcEvent.stopPropagation(), angular.isFunction(r) && e.$apply(function () {
                            r(t)
                        })
                    }

                    function i() {
                        return d.on(t, a), function () {
                            d.off(t)
                        }
                    }

                    function c(e, t) {
                        var n = t.indexOf("pan") > -1, r = t.indexOf("swipe") > -1;
                        return n && e.push([Hammer.Pan, {direction: Hammer.DIRECTION_HORIZONTAL}]), r && e.push([Hammer.Swipe, {direction: Hammer.DIRECTION_HORIZONTAL}]), e
                    }

                    var d = new Hammer(n[0], {recognizers: c([], t)});
                    return o || i(), e.$on("$destroy", function () {
                        d.destroy()
                    }), i
                }
            }
        ...
        function t(e, t) {
            return {restrict: "A", link: r(e, t, "SwipeLeft")}
        }

        function n(e, t) {
            return {restrict: "A", link: r(e, t, "SwipeRight")}
        }

        function r(e, t, n) {
            return function (r, o, a) {
                var i = n.toLowerCase(), c = "md" + n, d = e(a[c]) || angular.noop, l = t(r, i), m = function (e) {
                    d(r, e)
                };
                l(o, function (e) {
                    e.type == i && m()
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o, a, i) {
            function c(e, t) {
                var r = d.compile(e, t);
                return e.addClass("md-dragging"), function (e, t, c, d) {
                    function l(n, r) {
                        return s(e) ? n.preventDefault() : (r.width = f.prop("offsetWidth"), t.addClass("md-dragging"), void 0)
                    }

                    function m(e, t) {
                        var n = t.distance / t.width, r = d.$viewValue ? 1 - n : -n;
                        r = Math.max(0, Math.min(1, r)), f.css(o.CSS.TRANSFORM, "translate3d(" + 100 * r + "%,0,0)"), t.translate = r
                    }

                    function u(n, r) {
                        if (s(e))return !1;
                        t.removeClass("md-dragging"), f.css(o.CSS.TRANSFORM, "");
                        var a = Math.abs(r.distance || 0) < 2 || (d.$viewValue ? r.translate < .5 : r.translate > .5);
                        a && e.$apply(function () {
                    ...
                    d = d || n.fakeNgModel();
                    var s = a(c.ngDisabled), f = angular.element(t[0].querySelector(".md-thumb-container")), p = angular.element(t[0].querySelector(".md-container"));
                    i(function () {
                        t.removeClass("md-dragging")
                    }), c.mdNoClick = !0, r(e, t, c, d), n.attachDragBehavior(e, p), p.on("$md.dragstart", l).on("$md.drag", m).on("$md.dragend", u)
                }
            }
    ...
    function () {
        ...
        function t(e) {
            function t(e, t, n, r, o) {
                function a(r, a, i) {
                    a.addClass(i.position.split(" ").map(function (e) {
                        return "md-" + e
                    }).join(" ")), i.parent.addClass(c(i.position));
                    var d = n(r, "swipeleft swiperight");
                    return i.detachSwipe = d(a, function (t) {
                        a.addClass("md-" + t.type), e(o.cancel)
                    }), t.enter(a, i.parent)
                }

                function i(e, n, r) {
                    return r.detachSwipe(), r.parent.removeClass(c(r.position)), t.leave(n)
                }
                ...
                return {onShow: a, onRemove: i, position: "bottom left", themable: !0, hideDelay: 3e3}
            }

            return t.$inject = ["$timeout", "$animate", "$mdSwipe", "$mdTheming", "$mdToast"], e("$mdToast").setDefaults({
                methods: ["position", "hideDelay", "capsule"],
                options: t
            }).addPreset("simple", {
                argOption: "content",
                methods: ["content", "action", "highlightAction"],
                options: ["$mdToast", function (e) {
                    return {
        ...
        function e(e, t, n, r) {
            return {
                restrict: "E", controller: angular.noop, link: function (o, a, i) {
                    function c() {
                        function r(t, n) {
                            a.parent()[0] === n.parent()[0] && (m && m.off("scroll", p), n.on("scroll", p), n.attr("scroll-shrink", "true"), m = n, e(c))
                        }

                        function c() {
                            l = a.prop("offsetHeight"), m.css("margin-top", -l * f + "px"), d()
                        }

                        function d(e) {
                            var n = e ? e.target.scrollTop : s;
                            h(), u = Math.min(l / f, Math.max(0, u + n - s)), a.css(t.CSS.TRANSFORM, "translate3d(0," + -u * f + "px,0)"), m.css(t.CSS.TRANSFORM, "translate3d(0," + (l - u) * f + "px,0)"), s = n
                        }

                        var l, m, u = 0, s = 0, f = i.mdShrinkSpeedFactor || .5, p = e.debounce(d), h = n.debounce(c, 5e3);
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o, a, i) {
            function c(c, m, u) {
                function s(t) {
                    s.value = !!t, s.queued || (t ? (s.queued = !0, e(function () {
                        c.visible = s.value, s.queued = !1
                    }, c.delay)) : e(function () {
                        c.visible = !1
                    }))
                }
                ...
                function f() {
                    m.removeClass("md-hide"), g.attr("aria-describedby", m.attr("id")), E.append(m), h(), n(function () {
                        n(function () {
                            h(), c.visible && m.addClass("md-show")
                        })
                    })
                }

                function p() {
                    m.removeClass("md-show").addClass("md-hide"), g.removeAttr("aria-describedby"), e(function () {
                        c.visible || m.detach()
                    }, 200, !1)
                }

                function h() {
                    var e = o.elementRect(m, E), t = o.elementRect(g, E), n = "bottom", r = {
                        left: t.left + t.width / 2 - e.width / 2,
                        top: t.top + t.height
                    };
                    r.left = Math.min(r.left, E.prop("scrollWidth") - e.width - l), r.left = Math.max(r.left, l), r.top + e.height > E.prop("scrollHeight") && (r.top = t.top - e.height, n = "top"), m.css({
                        top: r.top + "px",
                        left: r.left + "px"
                    }), m.attr("width-32", Math.ceil(e.width / 32)), m.attr("md-direction", n)
                }

                a(m);
                for (var g = m.parent(), b = m.parent()[0]; b && b !== i[0] && b !== document.body && (!b.tagName || "md-content" != b.tagName.toLowerCase());)b = b.parentNode;
                var E = angular.element(b || document.body);
                angular.isDefined(u.mdDelay) || (c.delay = d), m.detach(), m.attr("role", "tooltip"), m.attr("id", u.id || "tooltip_" + o.nextUid()), g.on("focus mouseenter touchstart", function () {
                    s(!0)
                }), g.on("blur mouseleave touchend touchcancel", function () {
                    r[0].activeElement !== g[0] && s(!1)
                }), c.$watch("visible", function (e) {
                    e ? f() : p()
                });
                var v = n.debounce(function () {
                    c.visible && h()
                });
                angular.element(t).on("resize", v), c.$on("$destroy", function () {
                    c.visible = !1, m.remove(), angular.element(t).off("resize", v)
                })
            }
 ...
 */
    function () {
        ...
        function e(e) {
            function t(t, r, o, a) {
                function i() {
                    var e = c.getSelectedItem(), o = !e || c.count() < 2;
                    if (r.css("display", o ? "none" : "block"), !o && t.pagination && t.pagination.tabData) {
                        var a = c.getSelectedIndex(), i = t.pagination.tabData.tabs[a] || {
                                left: 0,
                                right: 0,
                                width: 0
                            }, d = r.parent().prop("offsetWidth") - i.right, l = ["md-transition-left", "md-transition-right", "md-no-transition"], m = n > a ? 0 : a > n ? 1 : 2;
                        r.removeClass(l.join(" ")).addClass(l[m]).css({left: i.left + 1 + "px", right: d + "px"}), n = a
                    }
                }

                if (!a[0]) {
                    var c = a[1], d = e.debounce(i);
                    c.inkBarElement = r, t.$on("$mdTabsPaginationChanged", d)
                }
            }
        ...
        function e(e, t, n, r, o, a) {
            function i(i, d, l, m) {
                function u(e, t) {
                    if (e) {
                        var n = b(e);
                        A.active && n !== A.page ? (t && t.element.blur(), E(n).then(function () {
                            e.element.focus()
                        })) : e.element.focus()
                    }
                }
                ...
                function s(e) {
                    var t = A.tabData, n = Math.max(0, Math.min(t.pages.length - 1, A.page + e)), r = t.pages[n][e > 0 ? "firstTabIndex" : "lastTabIndex"], o = m.itemAt(r);
                    u(o)
                }
                ...
                function f() {
                    function e() {
                        ...
                        }), E(b(m.getSelectedItem()))
                    }

                    function t() {
                        p(0), M.css("width", ""), r.css("width", ""), r.css("margin-left", ""), A.page = null, A.active = !1
                    }
                    ...
                    if (d.prop("offsetParent")) {
                        var r = d.find("md-tab");
                        t();
                        var a = A.tabData = g(), c = A.active = a.pages.length > 1;
                ...
                function p(t) {
                    ...
                    if (m.pagingOffset === t)return r.when();
                    var o = r.defer();
                    return m.$$pagingOffset = t, M.css(e.CSS.TRANSFORM, "translate3d(" + t + "px,0,0)"), M.on(e.CSS.TRANSITIONEND, n), o.promise
                }
                ...
                function g(e) {
                    function t() {
                        var e = 1 === u.length ? r : o, t = Math.min(Math.floor(e / l), v.length), n = Math.floor(e / t);
                        return a.css("width", n + "px"), g(!0)
                    }

                    var n, r = d.parent().prop("offsetWidth"), o = r - c - 1, a = angular.element(v), i = 0, l = 0, m = [], u = [];
                    return a.css("max-width", ""), angular.forEach(v, function (e, t) {
                        var a = Math.min(o, e.offsetWidth), c = {
                            element: e,
                            left: i,
                            width: a,
                            right: i + a,
                        ...
                        c.page = Math.ceil(c.right / (1 === u.length && t === v.length - 1 ? r : o)) - 1, c.page >= u.length ? (c.filler = o * c.page - c.left, c.right += c.filler, c.left += c.filler, n = {
                            left: c.left,
                            firstTabIndex: t,
                            lastTabIndex: t,
                            tabs: [c]
                        }, u.push(n)) : (n.lastTabIndex = t, n.tabs.push(c)), i = c.right, l = Math.max(l, a), m.push(c)
                ...
                function E(e) {
                    if (e !== A.page) {
                        var t = A.tabData.pages.length - 1;
                        return 0 > e && (e = 0), e > t && (e = t), A.hasPrev = e > 0, A.hasNext = t > e, A.page = e, i.$broadcast("$mdTabsPaginationChanged"), p(-A.tabData.pages[e].left)
                    }
                }

                var v = d[0].getElementsByTagName("md-tab"), $ = n.debounce(f), M = d.children(), A = i.pagination = {
                    page: -1,
                    active: !1,
                    clickNext: function () {
                        s(1)
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o, a, i, c) {
            ...
            function l(t, n) {
                p.content.length && (p.contentContainer.append(p.content), p.contentScope = e.$parent.$new(), t.append(p.contentContainer), r(p.contentContainer)(p.contentScope), n === !0 && c(function () {
                    a.disconnectScope(p.contentScope)
                }, 0, !1))
            }

            function m() {
                p.hammertime.destroy(), o.leave(p.contentContainer).then(function () {
                    p.contentScope && p.contentScope.$destroy(), p.contentScope = null
                })
            }

            function u(e) {
                p.contentContainer[e ? "addClass" : "removeClass"]("md-transition-rtl")
            }

            function s(n) {
                a.reconnectScope(p.contentScope), p.hammertime.on("swipeleft swiperight", e.onSwipe), t.addClass("active"), t.attr("aria-selected", !0), t.attr("tabIndex", 0), u(n), o.removeClass(p.contentContainer, "ng-hide"), e.onSelect()
            }

            function f(n) {
                a.disconnectScope(p.contentScope), p.hammertime.off("swipeleft swiperight", e.onSwipe), t.removeClass("active"), t.attr("aria-selected", !1), t.attr("tabIndex", -1), u(n), o.addClass(p.contentContainer, "ng-hide"), e.onDeselect()
            }

            var p = this;
            p.contentContainer = angular.element('<div class="md-tab-content ng-hide">'), p.hammertime = new Hammer(p.contentContainer[0]), p.element = t, p.isDisabled = d, p.onAdd = l, p.onRemove = m, p.onSelect = s, p.onDeselect = f;
            var h = i(n.ngDisabled)
        }
        ...
        function e(e, t, n, r, o) {
            function a(a, i) {
                ...
                return function (a, i, l, m) {
                    ...
                    function p(e) {
                        a.$apply(function () {
                            "swipeleft" === e.type ? $.select($.next()) : $.select($.previous())
                        })
                    }
                    ...
                    function g() {
                        function e(e) {
                            var t = $.getSelectedItem() === v;
                            e && !t ? $.select(v) : !e && t && $.deselect(v)
                        }
                    ...
                    var M = e.attachTabBehavior(a, i, {colorElement: $.inkBarElement});
                    $.add(v), a.$on("$destroy", function () {
                        M(), $.remove(v)
                    }), i.on("$destroy", function () {
                        o(function () {
                            $.scope.$broadcast("$mdTabsChanged")
                        }, 0, !1)
                    }), angular.isDefined(l.ngClick) || i.on("click", s), i.on("keydown", f), a.onSwipe = p, angular.isNumber(a.$parent.$index) && h(), angular.isDefined(l.mdActive) && g(), b()
                }
            }
    ...
    function () {
        ...
        function e(e, t, n) {
            ...
            function i(t, n) {
                if (p.contains(t) && !n) {
                    var o = r() === t, a = s() || u();
                    m(t), p.remove(t), t.onRemove(), e.$broadcast("$mdTabsChanged"), o && d(a)
                }
            }
            ...
            function d(t, n) {
                !t || t.isSelected || t.isDisabled() || p.contains(t) && (angular.isDefined(n) || (n = g(t) < e.selectedIndex), m(r(), n), e.selectedIndex = g(t), t.isSelected = !0, t.onSelect(n), e.$broadcast("$mdTabsChanged"))
            }
            ...
            h.count = p.count, h.getSelectedItem = r, h.getSelectedIndex = o, h.add = a, h.remove = i, h.move = c, h.select = d, h.focus = l, h.deselect = m, h.next = u, h.previous = s, e.$on("$destroy", function () {
                m(r());
