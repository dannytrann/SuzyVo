...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    a.fn.extend({
        openModal: function (b) {
            ...
            b = a.extend(e, b), b.dismissible && (a("#lean-overlay").click(function () {
                a(c).closeModal(b) , $('body').css('overflow', 'auto')
            }), a(document).keyup(function (d) {
                27 === d.keyCode && (a(c).closeModal(b), a(this).off(), $('body').css('overflow', 'auto'))
            })), a(c).find(".modal-close").click(function (d) {
                d.preventDefault(), a(c).closeModal(b), $('body').css('overflow', 'auto')
    ...
    var b = {
        init: function (b) {
            ...
            b = a.extend(c, b), a(this).each(function () {
                ...
                240 != b.menuWidth && (e.css("width", b.menuWidth), e.hasClass("fixed") || e.css("left", -1 * (b.menuWidth + 10))), "left" != b.edge && e.addClass("right-aligned"), a("body").append(a('<div class="drag-target"></div>')), a(".drag-target").css("left" === b.edge ? {left: 0} : {right: 0}), e.hasClass("fixed") && a(window).resize(function () {
                ...
                a(".drag-target").hammer({prevent_default: !1}).bind("tap", function () {
                    ...
                    if ("touch" === d.gesture.pointerType) {
                        ...
                        if ("left" === b.edge ? f > b.menuWidth ? f = b.menuWidth : 0 > f && (f = 0) : f < a(window).width() - b.menuWidth && (f = a(window).width() - b.menuWidth), "left" === b.edge ? f < b.menuWidth / 2 ? g = !1 : f >= b.menuWidth / 2 && (g = !0) : f < a(window).width() - b.menuWidth / 2 ? g = !0 : f >= a(window).width() - b.menuWidth / 2 && (g = !1), "left" === b.edge ? e.css("left", f - b.menuWidth) : e.css("right", -1 * (f - b.menuWidth / 2)), "left" === b.edge) {
                            var i = f / b.menuWidth;
                            a("#sidenav-overlay").velocity({opacity: i}, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            })
                    ...
                    if ("touch" === c.gesture.pointerType) {
                        ...
                        f = !1, "left" === b.edge ? g || -.5 > d ? (e.velocity({left: 0}, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad"
        ...
        a(document).on("mousedown", h, function (b) {
            ...
            a(this).each(function () {
                if ($select = a(this), !$select.hasClass("browser-default") && !$select.hasClass("initialized")) {
                    ...
                    $select.before(h), a("body").append(e), $select.is(":disabled") || h.dropdown({hover: !1}), $select.addClass("initialized"), h.on("focus", function () {
    ...
    a.fn.slider = function (b) {
        var c = {indicators: !0, height: 400, transition: 500, interval: 6e4};
        return b = a.extend(c, b), this.each(function () {
            function c(a, b) {
            ...
            function d(a) {
                console.log("Move to slide"), a >= h.length ? a = 0 : 0 > a && (a = h.length - 1), i = g.find(".active").index(), i != a && (e = h.eq(i), $caption = e.find(".caption"), e.removeClass("active"), e.velocity({opacity: 0}, {
    ...
    a(document).ready(function () {
        jQuery.fn.reverse = [].reverse, a(".fixed-action-btn").each(function () {
            var b = a(this);
            b.find("ul a.btn-floating").velocity({scaleY: ".4", scaleX: ".4", translateY: "40px"}, {duration: 0});
            b.hover(function () {
                var c = 0;
    ...
    a(document).ready(function () {
        ...
        showStaggeredList = function (c) {
            a(c).find("li").velocity({translateX: "-100px"}, {duration: 0}), a(c).find("li").each(function () {
                a(this).velocity({opacity: "1", translateX: "0"}, {duration: 800, delay: b, easing: [60, 10]}), b += 120
            })
        };
        var c = [];
